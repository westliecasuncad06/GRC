...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['action']) && $_POST['action'] === 'archive_all_2025_1st') {
        // Archive all classes for 1st semester 2025-2026 for this professor
        // Assuming school_year_semester table exists and join is possible
...
<body>
    ...
    <script>
        ...
        function confirmUnarchiveAll() {
            document.querySelector('form input[name="action"][value="unarchive_all_1st"]').form.submit();
        }
        ...
        function confirmArchiveAll() {
            // Submit the form
            document.querySelector('form input[name="action"]').form.submit();
        }

        // Close archive confirm modal when clicking outside
        window.onclick = function(event) {
