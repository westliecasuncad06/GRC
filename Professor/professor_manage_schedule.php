...
// (Removed testing bypasses) Authentication is enforced above.
...
<head>
    ...
    <style>
        ...
        /* Make attendance modal title and attendance date headers white */
...
function saveAttendance(date) {
    ...
    // Dropdown behaviour is handled in the included navbar script (../includes/navbar_professor.php)
