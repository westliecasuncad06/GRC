-- Migration to create unenrollment_requests table
-- This fixes the issue where pending unenrollment requests don't show in Professor dashboard

CREATE TABLE IF NOT EXISTS `unenrollment_requests` (
