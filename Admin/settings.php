                ...
                try {
                    ...
                    if (password_verify($current_password, $user['password'])) {
                        ...
                        if ($role == 'professor') {
                            ...
                            $stmt = $pdo->prepare("UPDATE administrators SET password = ?, updated_at = NOW() WHERE admin_id = ?");
                        }
...
<body class="<?php echo $role; ?>">
    ...
    if ($role == 'admin') {
        ...
        include '../includes/navbar_professor.php';
    } elseif ($role == 'student') {
    ...
    <div class="admin-sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="admin_manage_schedule.php" class="nav-item">
                    ...
                    <form action="" method="POST" class="form-section-enhanced">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group-enhanced">
                                ...
                                <input type="text" name="mobile" class="form-input-enhanced" value="<?php echo htmlspecialchars($user['mobile'] ?? '+639000000000'); ?>" required placeholder="Enter your mobile number">
                            </div>
                        </div>
